  ...
  try {
    ...
    try {
      ...
      await createLoginLog({
        ...
        loginMethod: 'google',
        success: true,
        message: mode === 'register' ? 'Google registration successful' : 'Google login successful',
      })
    } catch (logError: any) {
      console.error('Failed to create Google login log:', logError?.message)
    }
